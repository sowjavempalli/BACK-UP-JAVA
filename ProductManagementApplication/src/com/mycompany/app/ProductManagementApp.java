...
public class ProductManagementApp {
    ...
    public static void viewProducts()
    {
        ...
        List<product1> productList = dao.getAllProducts();
    ...
    public static void addProduct() throws Exception
    {
        ...
        product1 product = new product1(productId, productName,productPrice);
    ...
    public static void displayProduct(product1 product)
    {
